    ...
    <div className="max-w-3xl">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
        ...
        <p className="text-sm text-gray-700 leading-relaxed mb-3">
          The Community of Practice (CoP) brings together stakeholders working across programme countries
          and thematic areas. The CoP facilitates knowledge sharing,
          peer learning, and collaborative problem-solving.
        </p>
        <p className="text-sm text-gray-700 leading-relaxed">
          Published resources on this portal have been validated by the programme team and are available for
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
        ...
        <div className="bg-gray-50 rounded p-4 text-sm">
          ...
          <div className="mt-1"><strong>Programme Lead:</strong> Programme Management Team</div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <p className="text-sm text-gray-700 leading-relaxed">
          All materials published on this portal are shared for learning purposes within the Community
